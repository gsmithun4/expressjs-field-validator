...
describe('Test for validateBody', () => {
  ...
  test('validateBody validator object isMatching with regex', () => {
    validateBody().addParams([
      param('test').isMatching(/^[A-Z]+-\d+$/)
    ]);
    expect(validator).toHaveBeenCalledWith('body',
      [{
        param: 'test',
  ...
  test('validateBody validator object isMatching with string pattern', () => {
    validateBody().addParams([
      param('test').isMatching('^\\d{5}$')
    ]);
    expect(validator).toHaveBeenCalledWith('body',
      [{
        param: 'test',
  ...
  test('validateBody validator object isMatching combined with isRequired', () => {
    validateBody().addParams([
      param('test').isRequired().isMatching(/^[a-z_]+$/)
    ]);
    expect(validator).toHaveBeenCalledWith('body',
      [{
        param: 'test',
